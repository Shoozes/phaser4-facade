...
function installGMRuntime(root, Phaser) {
    ...
    function callActive(method, args) {
        return  (active())[method].apply(null, args);
    }
    ...
    function makeRuntime(scene, cfg) {
        ...
        const api = {
            ...
            layout() {
                const render = syncRenderResolution(scene, state, cfg,  ( (root)));
            ...
            button(x, y, w, h, text, onTap, options) {
                ...
                if (!buttonObject) {
                    buttonObject = new GMButtonObject(scene, api,  (state), id);
            ...
            modal_notice(title, message, options) {
                if (title && typeof title === "object") {
                    return createModal(api,  (state), title,  (uiToolkit));
                }
                return createModal(api,  (state), Object.assign({}, options || {}, { title, message }),  (uiToolkit));
            },
            modal_close_all() {
            ...
            curtain(text, fadeMs) {
                return curtain(text, fadeMs,  (state), api, scene,  (cfg), normalizeDelayMs, COLORS, ALIGN, INPUT);
            },
            curtain_active() {
                return curtain_active( (state));
            },
