...
html.style.setProperty("margin", "4px"); body.style.setProperty("touch-action", "auto"); parent.style.setProperty("width", "40px"); canvas.style.setProperty("display", "inline");
...
assert.equal(host.restore(), true); assert.equal(host.restore(), false); assert.equal(html.style.getPropertyValue("margin"), "4px"); assert.equal(body.style.getPropertyValue("touch-action"), "auto"); assert.equal(parent.style.getPropertyValue("width"), "40px"); assert.equal(canvas.style.getPropertyValue("display"), "inline");
